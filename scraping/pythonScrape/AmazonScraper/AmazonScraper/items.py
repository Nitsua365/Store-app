...
class AmazonscraperItem(scrapy.Item):
    ...
    affiliatelink = scrapy.Field(input_processor=MapCompose(remove_tags, initialClean, removeHTMLChars, cleanQueryParams, addAffiliateParams), output_processor=TakeFirst())
