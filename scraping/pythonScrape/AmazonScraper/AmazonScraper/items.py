...
class AmazonscraperItem(scrapy.Item):
    ...
    affiliatelink = scrapy.Field(input_processor=MapCompose(remove_tags, initialClean, removeHTMLChars, appendAmazonURL, cleanQueryParams, addAffiliateParams), output_processor=TakeFirst())
