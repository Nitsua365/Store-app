    ...
    return (
      <div className="flex items-center mb-3">
        ...
        <div class="inline-flex mt-2 xs:mt-0">
          <button onClick={() => setStateVar('currentPage', currentPage - 1)} class="inline-flex items-center py-2 px-4 text-sm font-medium text-red rounded transition-color duration-300 border-2 border-gray-400 dark:hover:border-blue-400 dark:hover:text-red-500">
